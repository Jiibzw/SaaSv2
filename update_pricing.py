        ...
        <main class="main-content">
            ...
            <div class="pricing-grid">
                ...
                <div class="pricing-card">
                    <div class="plan-badge badge-current">Actuel</div>
                    ...
                    <button class="btn-plan btn-disabled" disabled>Plan Actuel</button>
                </div>

                <!-- Pro -->
                <div class="pricing-card featured">
                    <div class="plan-badge badge-popular">Populaire</div>
                    <div class="plan-name">Pro</div>
                    <div class="plan-price">59€<span>/mois</span></div>
                    <ul class="features-list">
                    ...
                    <button class="btn-plan btn-primary" onclick="alert('Contactez-nous pour passer au plan Pro !')">Passer au Pro</button>
                </div>

                <!-- Premium -->
                <div class="pricing-card premium">
                    <div class="plan-badge badge-new">Nouveau</div>
                    <div class="plan-name">Premium</div>
                    <div class="plan-price">75€<span>/mois</span></div>
                    <ul class="features-list">
