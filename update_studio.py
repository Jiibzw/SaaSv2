...
<body>
    ...
    <div class="container">
        ...
        <div id="booking-section" class="booking-wrapper">
            <div class="booking-header">
                <h2 style="margin:0">📅 Réserver un rendez-vous</h2>
                <p style="margin:0.5rem 0 0; opacity:0.9">Votre style mérite le meilleur</p>
            </div>
            ...
            <div id="step-1" class="step-content active">
                <h3 style="margin-bottom:1.5rem">Choisissez votre expert</h3>
                <div class="coiffeurs-grid" id="coiffeurs-list"></div>
            ...
            <div id="step-2" class="step-content">
                <h3 style="margin-bottom:1.5rem">Choisissez une date</h3>
            ...
            <div id="step-3" class="step-content">
                <h3 style="margin-bottom:1.5rem">Choisissez un créneau</h3>
                <div class="time-slots" id="time-slots"></div>
                <div class="button-group">
                    <button class="btn-secondary" onclick="goToStep(2)">Retour</button>
                    <button class="btn-primary" id="btn-next-3" disabled>
                        Suivant <i class="fa-solid fa-arrow-right"></i>
                    </button>
                </div>
            </div>
            ...
            <div id="step-4" class="step-content">
                ...
                <form id="booking-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="telephone" placeholder="0612345678" required pattern="[0-9]{10}">
                        <span class="error-message" id="tel-error">
                            <i class="fa-solid fa-circle-exclamation"></i> Numéro invalide (10 chiffres requis)
                        </span>
                    </div>
                    <div class="form-group">
    ...
    <div id="modal-confirmation" class="modal">
        <div class="modal-content">
            ...
            <p style="color: var(--gray); margin-bottom: 2rem;">Votre rendez-vous a été enregistré avec succès.</p>
            
            <div id="confirmation-details" style="background: #f8fafc; padding: 1.5rem; border-radius: 1rem; margin-bottom: 2rem; text-align: left;"></div>
            
            <button class="btn-primary" onclick="resetBooking()" style="width: 100%;">
